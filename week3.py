...
# part 2
while True:
    value = int(input("Give a length in inches: "))
    if value < 0:
        break
    else:
        print(f"The length in centimeters is {value * 2.54:.02f}.")
...
# print pi
print(f"estimated value of pi = {pi:.4f} and degree of error is {math.pi - pi}")
